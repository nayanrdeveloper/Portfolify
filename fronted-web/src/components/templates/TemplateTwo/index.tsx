...
export default function TemplateTwo() {
  ...
  const userTitle = "A Software Engineer based in Morocco, focusing on building enterprise solutions.";
  ...
  const experienceTimeline = [
    {
      ...
      company: "TechCorp",
      date: "2023 - Present",
      description: "Building microservices and front-end apps with React.",
    },
    {
      id: 2,
      ...
      <section className="max-w-6xl mx-auto bg-white shadow rounded-lg p-6 mb-6">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between">
          ...
          <div className="mt-4 md:mt-0 grid grid-cols-2 gap-4 md:gap-6 text-center">
            <div>
              <p className="text-xl font-semibold">{githubStats.followers}</p>
              <p className="text-sm text-gray-500">Followers</p>
            </div>
            <div>
              <p className="text-xl font-semibold">{githubStats.following}</p>
              <p className="text-sm text-gray-500">Following</p>
            </div>
            <div>
              <p className="text-xl font-semibold">{githubStats.contributions}</p>
              <p className="text-sm text-gray-500">Contributions</p>
            </div>
            <div>
              <p className="text-xl font-semibold">{githubStats.stars}</p>
      ...
      <section className="max-w-6xl mx-auto mb-6 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <div className="space-y-3">
            <div className="border-b pb-2">
              <h3 className="text-md font-semibold">React 18 New Features</h3>
              <p className="text-sm text-blue-500 hover:underline cursor-pointer">
                Read More
              </p>
            </div>
            <div className="border-b pb-2">
              <h3 className="text-md font-semibold">Node.js Streaming & Tutorial</h3>
              <p className="text-sm text-blue-500 hover:underline cursor-pointer">
                Read More
              </p>
            </div>
            <div>
              <h3 className="text-md font-semibold">Deploying Docker Apps on AWS</h3>
              <p className="text-sm text-blue-500 hover:underline cursor-pointer">
                Read More
              </p>
            </div>
        ...
        <div className="bg-white shadow rounded-lg p-6">
          ...
          <div className="mb-4">
            ...
            <p className="text-sm text-gray-600">English, French, Arabic</p>
          </div>
          <div>
            <h3 className="text-md font-semibold">Hobbies</h3>
            <p className="text-sm text-gray-600">Reading, Music, Gaming</p>
          </div>
        </div>
      </section>
